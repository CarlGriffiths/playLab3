...
class Routes(
  ...
  // @LINE:8
  private[this] lazy val controllers_HomeController_product2_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("product")))
  )
  private[this] lazy val controllers_HomeController_product2_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:8
    case controllers_HomeController_product2_route(params@_) =>
      call { 
        controllers_HomeController_product2_invoker.call(HomeController_0.product)
      }
